...
/**
 * UCenter storage for all storage types
 *
 ...
 */
class OAuth2_Storage_UCenter implements OAuth2_Storage_AuthorizationCodeInterface,
    ...
    OAuth2_Storage_UserCredentialsInterface, OAuth2_Storage_RefreshTokenInterface, OAuth2_Storage_JWTBearerInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        ...
        $this->config = array_merge(array(
            'client_table' => UC_DBTABLEPRE . 'oauth_clients',
            'access_token_table' => UC_DBTABLEPRE . 'oauth_access_tokens',
            'refresh_token_table' => UC_DBTABLEPRE . 'oauth_refresh_tokens',
            'code_table' => UC_DBTABLEPRE . 'oauth_authorization_codes',
            'user_table' => UC_DBTABLEPRE . 'members',
            'jwt_table' => UC_DBTABLEPRE . 'oauth_jwt',
        ), $config);
    }
